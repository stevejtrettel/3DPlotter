...
//
//    let phi = params.angle + 0.4 * wiggle * Math.cos(2 * s);
//    let theta = params.theta + wiggle * Math.sin(s);
//
...
//
//    let pos = new THREE.Vector3(1, 0, 0).multiplyScalar(5. * params.p);
//
//    let st; //state
//    let stateList = [];
//
...
//
//
//    velList = singleRing(initialCondition(currentTime, 0), currentTime);
//    curves = curveSpray(velList);
//
